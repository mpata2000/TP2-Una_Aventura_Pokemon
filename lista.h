...
/*
 * Destructor de elementos. Libera los elementos almacenados en la lista
 */
typedef void (*nodo_destructor)(void*);
 ...
 * Recive el destructor de elementos si es necesario
